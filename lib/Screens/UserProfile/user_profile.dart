                            ...
                            child: Padding(
                              ...
                              child: Column(
                                children: [
                                  ...
                                  Text("Samantha Mensah", style: TextStyle(fontSize: 17, fontWeight: FontWeight.w600), textAlign: TextAlign.center,),
                                  SizedBox(
                                    height: 5,
                                  ),
                                  Text("samanthamensag@gmail.com", style: TextStyle(fontSize: 12, color: barterPrimary2), textAlign: TextAlign.center,),
                                  SizedBox(
                                    height: 5,
                                  ),
                                ...
                                Column(
                                  ...
                                  children: [
                                    Center(
                                        child: Wrap(
                                          children: [
                                            Text("Credits", style: TextStyle(color: Colors.white, fontSize: 11,),),
                                          ],
                                        )
                                    ),
                                    SizedBox(
                                    ...
                                    Center(
                                        child: Wrap(
                                          children: [
                                            Row(
                                              children: [
                                                Text("3048.34", style: TextStyle(color: barterPrimary2, fontSize: 18, fontWeight: FontWeight.w600),),
                                              ],
                                            ),
                                          ],
                                        )
