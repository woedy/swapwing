class GarageItemDetailModel {
  String? response;
  Data? data;

  GarageItemDetailModel({this.response, this.data});

  GarageItemDetailModel.fromJson(Map<String, dynamic> json) {
...
class Data {
  GarageItemDetail? garageItemDetail;

  Data({this.garageItemDetail});

  Data.fromJson(Map<String, dynamic> json) {
    garageItemDetail = json['garage_item_detail'] != null
        ? new GarageItemDetail.fromJson(json['garage_item_detail'])
        : null;
  }

  Map<String, dynamic> toJson() {
    final Map<String, dynamic> data = new Map<String, dynamic>();
    if (this.garageItemDetail != null) {
      data['garage_item_detail'] = this.garageItemDetail!.toJson();
    }
    return data;
  }
}

class GarageItemDetail {
  String? itemId;
  int? garage;
  String? itemName;
  String? description;
  ...
  GarageItemDetail.fromJson(Map<String, dynamic> json) {
    itemId = json['item_id'];
    garage = json['garage'];
