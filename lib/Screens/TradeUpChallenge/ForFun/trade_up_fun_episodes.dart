...
class TradeUpFunEpisodes extends StatefulWidget {
  TradeUpFunEpisodes({Key? key}) : super(key: key);

  @override
  _TradeUpFunEpisodesState createState() => _TradeUpFunEpisodesState();
}

class _TradeUpFunEpisodesState extends State<TradeUpFunEpisodes> {
  @override
                                  ...
                                  child: Column(
                                    ...
                                    children: [
                                      ...
                                      Container(
                                        ...
                                        child: Text("Trade 1 😃✌️.. New Owner just revealed the house in town the house in town the house in town the house in town the house in town", maxLines: 3, overflow: TextOverflow.ellipsis,  style: TextStyle(color: barterPrimary),),
